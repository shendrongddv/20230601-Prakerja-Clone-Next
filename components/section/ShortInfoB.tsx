...
const ShortInfoB = () => {
  ...
  return (
    <section className="isolate z-20 -mt-8 rounded-tl-3xl rounded-tr-3xl bg-white px-6 py-16">
      <div className="container mx-auto">
        <div className="flex flex-col items-center justify-between gap-8 sm:flex-row">
          {/* Right */}
          <div className="w-full space-y-6 sm:w-5/12">
            {/* # */}
          ...
          <div className="flex w-full flex-col gap-8 rounded-3xl bg-slate-100 p-6 sm:w-6/12 sm:px-9 sm:py-10">
